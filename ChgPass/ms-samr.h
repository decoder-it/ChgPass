...
#define __samr_INTERFACE_DEFINED__
    ...
    typedef struct _UNICODE_STRING {
        USHORT Length;        // The length, in bytes, of the string (not including the null terminator).
        USHORT MaximumLength; // The total size, in bytes, allocated for the string buffer.
        PWSTR Buffer;         // Pointer to the actual string buffer.
...
#pragma pack()
    ...
    long SamrConnect(
        /* [unique][in] */ PUNICODE_STRING ServerName,
